                    ...
                    <xsl:for-each select="wfac/group/participant" xml:space="preserve">
                        ...
                        <fo:table>
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row>
                                    <fo:table-cell border="0.5pt solid black" padding="1pt" text-align="center"><fo:block>Target 2</fo:block></fo:table-cell>
                                    <xsl:for-each select="scorecard/scorecard-entry[@target-id = 'target-2']" xml:space="preserve">
                                        <fo:table-cell border="0.5pt solid black" padding="1pt" text-align="center"><fo:block><xsl:value-of select="@score"/></fo:block></fo:table-cell>
                                    </xsl:for-each>
                                </fo:table-row>
                                ...
                                <xsl:if test="scorecard/scorecard-entry[@target-id = 'target-3']">
                                    <fo:table-row>
                                        <fo:table-cell border="0.5pt solid black" padding="1pt" text-align="center"><fo:block>Target 3</fo:block></fo:table-cell>
                                        <xsl:for-each select="scorecard/scorecard-entry[@target-id = 'target-3']" xml:space="preserve">
                                            <fo:table-cell border="0.5pt solid black" padding="1pt" text-align="center"><fo:block><xsl:value-of select="@score"/></fo:block></fo:table-cell>
                                        </xsl:for-each>
                                    </fo:table-row>
                                </xsl:if>
