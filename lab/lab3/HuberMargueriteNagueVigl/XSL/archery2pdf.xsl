                ...
                <fo:table-body>
                    <xsl:for-each select="score">
                        <fo:table-row space-after="1.5pt">
                            <fo:table-cell>
                                <fo:block><fo:inline text-transform="capitalize"><xsl:call-template name="getNameOfParticipant"><xsl:with-param name="p_id" select="@participant_id"/></xsl:call-template></fo:inline></fo:block>
                            </fo:table-cell>
                            <fo:table-cell>
