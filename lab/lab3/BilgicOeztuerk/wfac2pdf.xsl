    ...
    <xsl:template match="/tournament">
        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="tournament-page">
                <fo:flow flow-name="xsl-region-body" color="black" text-align="center" font-weight="bold" font-family="sans-serif" font-size="28pt">
                    <fo:block margin-top="30mm">World Outdoor Flint Archery Mail Match 2022</fo:block>
                </fo:flow>
            </fo:page-sequence>
            ...
            <fo:page-sequence master-reference="tournament-page">
                ...
                <fo:flow flow-name="xsl-region-body" font-family="sans-serif" font-size="24pt">
                    ...
                    <fo:list-block space-before="24pt" font-size="15pt" font-style="italic">
            ...
            <xsl:for-each select="group/athlete">
                ...
                <fo:page-sequence master-reference="tournament-page">
                    ...
                    <fo:flow flow-name="xsl-region-body">
                        ...
                        <!-- Überschrift -->
                        <fo:block id="{generate-id()}" font-size="24" font-weight="bold" font-style="italic" text-decoration="underline">
                        ...
                        <fo:table margin-top="7pt" border-spacing="1" line-height="2"
                            ...
                            <fo:table-header border-width="1pt" border-style="solid"
                                background-color="orange" padding="1">
                                <fo:table-row>
                                    <fo:table-cell>
                                    ...
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">1. Versuch</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">2. Versuch</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
                                        <fo:block font-weight="bold">3. Versuch</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell>
