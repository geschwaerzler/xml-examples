        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="archery-page">
                <fo:flow flow-name="xsl-region-body" font-family="sans-serif" font-size="9pt">
                    ...
                    <xsl:call-template name="headline">
                        <xsl:with-param name="text" select="'Scorecards'"/>
                    </xsl:call-template>
                    ...
                    <xsl:call-template name="headline">
                        <xsl:with-param name="text" select="'Categories'"/>
                    </xsl:call-template>
                    ...
                    <xsl:call-template name="headline">
                        <xsl:with-param name="text" select="'Locations and Courses'"/>
                    </xsl:call-template>
                    <xsl:apply-templates select="."
                        mode="locations" />
                    
                    <xsl:call-template name="headline">
                        <xsl:with-param name="text" select="'Schedule'"/>
                    </xsl:call-template>
                    <xsl:apply-templates select="."
                        mode="schedules" />
    ...
    <xsl:template match="/archery-contest" mode="table-of-contents">
        ...
        <fo:list-block>
            <fo:list-item>
                ...
                <fo:list-item-body start-indent="body-start()"><fo:block>Scorecard</fo:block></fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label end-indent="label-end()">
                    <fo:block>
                ...
                <fo:list-item-body start-indent="body-start()"><fo:block>Participants</fo:block></fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label end-indent="label-end()">
                    <fo:block>
                ...
                <fo:list-item-body start-indent="body-start()"><fo:block>Categories</fo:block></fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label end-indent="label-end()">
                    <fo:block>
                ...
                <fo:list-item-body start-indent="body-start()"><fo:block>Locations and Courses</fo:block></fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label end-indent="label-end()">
                    <fo:block>
                ...
                <fo:list-item-body start-indent="body-start()"><fo:block>Schedules</fo:block></fo:list-item-body>
            </fo:list-item>
        </fo:list-block>
