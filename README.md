# xml-examples
This repo extends the eclipse demo-project "XMLExamples" with some examples that I develop
during the lecture and lab of my course "Data Management with XML" held at FH Vorarlberg.
The project has been renamed to "xml-examples" for this purpose.

## Installation - IntelliJ

1. From the IntelliJ "File" menu select "New" > "Project from Version Control…".
2. In the dialog select "Repository URL" and "Git" for version control.
   Fill in "https://github.com/geschwaerzler/xml-examples.git" as URL.
   <img src="readme-img/intellij-clone-repo.png" alt="select the Git perspective from the list" width="912px"/>
...
1. (Deselect All) branches and select "SS25" as initial branch and (Next >).  
